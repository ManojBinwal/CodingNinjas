...
public class MultiplyTwoLinkedLists {
    ...
    public static void main(String[] args) {
        ...
        LinkedListNode<Integer> head1 = new LinkedListNode<Integer>(9);
        head1.next = new LinkedListNode<Integer>(4);
        head1.next.next = new LinkedListNode<Integer>(6);

        // Create the second linked list
        LinkedListNode<Integer> head2 = new LinkedListNode<Integer>(8);
        head2.next = new LinkedListNode<Integer>(4);
